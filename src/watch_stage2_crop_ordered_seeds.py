...
ROOT=Path(__file__).resolve().parents[1];WATCH=ROOT/'artifacts/stage2-crop-ordered-seeds-watch-20260916';RESULT=ROOT/'artifacts/stage2-crop-ordered-seeds-20260916/report.json';SCRIPT=ROOT/'src/run_stage2_crop_ordered_seeds.py';TIMEOUT=3600
...
def main():
 ...
 except FileExistsError as exc:raise RuntimeError('Ordered crop watcher already started') from exc
