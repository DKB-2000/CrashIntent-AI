...
ROOT=Path(__file__).resolve().parents[1];WATCH=ROOT/'artifacts/stage2-crop-task-specific-seeds-v2-watch-20260917';RESULT=ROOT/'artifacts/stage2-crop-task-specific-seeds-v2-20260917/report.json';SCRIPT=ROOT/'src/run_stage2_crop_task_specific_seeds.py';TIMEOUT=3600
...
def main():
 ...
 except FileExistsError as exc:raise RuntimeError('Task-specific crop watcher already started') from exc
