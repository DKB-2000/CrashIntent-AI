...
ROOT=Path(__file__).resolve().parents[1];WATCH=ROOT/'artifacts/stage2-nexar-temporal-pool-watch-20260917';RESULT=ROOT/'artifacts/stage2-nexar-temporal-pool-20260917/download-status.json';SCRIPT=ROOT/'src/download_nexar_stage2_temporal_pool.py';TIMEOUT=14400
...
def main():
 ...
 except FileExistsError as exc:raise RuntimeError('Nexar temporal pool watcher already started') from exc
