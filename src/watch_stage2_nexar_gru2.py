...
ROOT=Path(__file__).resolve().parents[1];WATCH=ROOT/'artifacts/stage2-nexar-gru2-watch-20260918';RESULT=ROOT/'artifacts/stage2-nexar-gru2-20260918/status.json';SCRIPT=ROOT/'src/train_stage2_nexar_gru2.py';TIMEOUT=14400
