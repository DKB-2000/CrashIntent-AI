...
ROOT=Path(__file__).resolve().parents[1];WATCH=ROOT/'artifacts/stage2-mmau-label-acquisition-watch-20260917';RESULT=ROOT/'artifacts/stage2-mmau-label-acquisition-20260917/status.json';SCRIPT=ROOT/'src/download_mmau_detection_labels.py';TIMEOUT=1800
...
def main():
 ...
 except FileExistsError as exc:raise RuntimeError('MM-AU label watcher already started') from exc
