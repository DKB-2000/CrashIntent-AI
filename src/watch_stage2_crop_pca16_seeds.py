...
ROOT=Path(__file__).resolve().parents[1];WATCH=ROOT/'artifacts/stage2-crop-pca16-seeds-watch-20260917';RESULT=ROOT/'artifacts/stage2-crop-pca16-seeds-20260917/report.json';SCRIPT=ROOT/'src/run_stage2_crop_pca16_seeds.py';TIMEOUT=3600
...
def main():
 ...
 except FileExistsError as exc:raise RuntimeError('PCA16 watcher already started') from exc
