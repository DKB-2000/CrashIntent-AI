...
$worker=Join-Path $root 'src\download_stage3_civic_535_training.py'
$taskName='CrashIntent-Stage3-Civic-Training-Acquisition'
...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Principal $principal -Description 'Finite acquisition of three disjoint Civic Stage3 proxy-training routes.' -Force|Out-Null
